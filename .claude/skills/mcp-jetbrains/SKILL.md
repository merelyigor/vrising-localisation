...
змінюється — тоді або експортувати `PHPSTORM_MCP_URL`, або синхронізувати локальні
конфіги скриптом `bash scripts/sync-phpstorm-mcp-port.sh`, а не вгадувати порт.
